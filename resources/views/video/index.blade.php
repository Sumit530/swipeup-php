                                    ...
                                    <tbody>
                                        @if(!empty($videos))
                                            ...
                                            if ($video->cover_image != '') 
                                            {
                                                ...
                                                if(File::exists($deldestinationPath.'/'.$video->cover_image)) {
                                                    $cover_image = url('storage/app/public/uploads/videos/cover_images/'.$video->cover_image);
                                                }
                                                else
                                                {
                                                    $cover_image = "";
                                            ...
                                            if ($video->file_name != '') 
                                            {
                                               $delddestinationPath =  Storage::disk('public')->path('uploads/videos/videos');
                                                if(File::exists($delddestinationPath.'/'.$video->file_name)) {
                                                    $video_url = url('storage/app/public/uploads/videos/videos/'.$video->file_name);
                                                }
                                                else
                                                {
                                                    $video_url = "";
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ $cover_image }}" target="_blank">{{ $video->cover_image }}</a></td>
                                                <td><a href="{{ $video_url   }}" target="_blank">{{ $video->file_name }}</a></td>
                                                <td>
                                                    @if($video->is_view == 1)
                                                    Public
