            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Add new song</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">add new song
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    @endforeach
                                    <form class="form" id="form" action="{{ route('songs.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Enter duration" name="duration" id="duration" value="{{ old('duration') }}"/>
                                                </div>
                                            </div>
