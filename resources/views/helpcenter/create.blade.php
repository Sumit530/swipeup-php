            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Add new help center</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">add new help center
                                    </li>
                                </ol>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Add new help center</h4>
                                </div>
                                <div class="card-body">
                                    ...
                                    @endforeach
                                    <form class="form" id="form" action="{{ route('helpcenter.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="title">Title <span class="required_sign">*</span></label>
                                                    <input type="text" id="title" class="form-control" placeholder="Enter title" name="title" value="{{ old('title') }}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-12">
                                                <div class="mb-1">
                                                    <label class="form-label" for="editor">Details <span class="required_sign">*</span></label>
                                                    <textarea class="form-control" name="details" id="editor">{{ old('details') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-12">
