...
@section('content')
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            <a href="{{ url('admin/helpcenter/create') }}" class="btn-icon btn btn-primary btn-round btn-sm" type="button" title="" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Add new help center">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <table class="datatables-basic table" id="datatables">
                                    ...
                                    <tbody>
                                        @if(!empty($helpcenter))
                                            @foreach($helpcenter as $k => $row)
                                            <tr>
                                                <td>{{ $k+1 }}</td>
                                                <td>{{ $row->title }}</td>
                                                <td>{{ strip_tags(mb_strimwidth($row->details, 0, 100,'...')) }}</td>
                                                <td>
                                                    @if($row->status == 1)
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end" style="">
                                                            ...
                                                            @endif
                                                            <a class="dropdown-item" href="{{ route('helpcenter.edit',array($row->id)) }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">Change help center</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="form" id="status_model" action="{{ route('admin.helpcenter-status') }}" method="POST">
                @csrf
    ...
    <div class="modal fade text-start" id="delete-model" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel1">Delete help center</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form class="form" id="delete_model" action="{{ route('admin.helpcenter-delete') }}" method="POST">
                @csrf
                <div class="modal-body">
                    <p>
                        Are you sure want to delete this helpcenter..?
                    </p>
                </div>
                <div class="modal-footer">
                    <input type="hidden" name="id">
